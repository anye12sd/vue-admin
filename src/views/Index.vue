    ...
    <div>
        <a-layout class="layout-outbox">
            <a-layout-sider v-model="collapsed" :trigger="null" collapsible class="left-nav-box">
                <left-slide-nav :selected-key="['sub1']" :opened-key="['sub1']" :show-title="collapsed"
...
<style scoped>
    .layout-box-content-flex{
        flex-wrap: wrap;
    }

    .layout-box-content .drawer-box-content{
        margin-right: 20px;
        width: 133px;
    }
    .layout-box-content .drawer-box-content-img{
        text-align: center;
        margin: 0 auto;
        width: 40px;
        height: 40px;
