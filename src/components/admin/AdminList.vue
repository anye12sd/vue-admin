  ...
  <div>
    <a-layout id="components-layout-demo-top-side-2">
      <a-layout-sider v-model="collapsed" :trigger="null" collapsible>
        <left-slide-nav :selected-key="['3']" :opened-key="['sub4']" :show-title="collapsed" @DrawerStatus="getDrawerStatus"></left-slide-nav>
      </a-layout-sider>
        ...
        >
          <div class="content-top flex">
            <div class="content-top-btn" style="margin-right: 8px">
              <router-link to="/admin/AddNewAdmin"><a-button type="primary"> <a-icon type="plus" />新增管理员</a-button></router-link>
            </div>
